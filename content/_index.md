...
sections:
  - section_id: hero
    ...
    content: >-
      Handle atomic operations in distributed environments with ease. TestAndSet API handles custom web-based mutexes and provides you an automated solution that can be       integrated right in your scripts no matter what language you use for development!
